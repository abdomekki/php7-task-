        ...
        if ($result_c->num_rows > 0) {
            ...
            ?>
                ...
                <form action="" method="post">
                    <input type="text" name="p_search" placeholder="Enter Product Name" required>
                    <br>
                    <input type="submit" name="getprod" value="Go">
                </form>
            <?php
                    ...
                    if (isset($_POST["getprod"])) {
                        # code...
                        $prod=$_POST["p_search"];
                        $sql = "SELECT productName FROM products where productName LIKE '%$prod%' ";
            ...
            ?>
                ...
                <form action="q4.php" method="post">
                    <input type="submit" name="q4" value="Next">
                </form>
